local conf = 
{
	...
	upID = 10006,
	population = 1,
	displayCSB = "UI/displayAni/displayAni1011.csb",
	...
	components = 
	{
...

		{
			...
			csbPath = "UI/characters/LowerSoldierBlue.csb",
		...
		-- 	pngPath = "UI/TextureUI/LowerSoldierBlue.png",
		-- 	defaultSp = "LowerSoldierBlue-stand01_00.png",
		...
		-- 	aniAttackCallback = 
		-- 	{
		-- 		"LowerSoldierBlue-attack01_17.png",
		-- 		"LowerSoldierBlue-attack02_18.png",
		-- 	},

		-- 	aniStrMap = 
		-- 	{
		-- 		["stand01"] = {str = "LowerSoldierBlue-stand01_%s.png",startIndex = 0,endIndex = 29,time= 0.03 },
		-- 		["stand02"] = {str = "LowerSoldierBlue-stand02_%s.png",startIndex = 0,endIndex = 52,time= 0.03 },
		-- 		["die"] = {str = "LowerSoldierBlue-die_%s.png",startIndex = 0,endIndex = 24,time= 0.03 },
		-- 		["walk"] = {str = "LowerSoldierBlue-walk_%s.png",startIndex = 0,endIndex = 23,time= 0.03 },
		-- 		["attack01"] = {str = "LowerSoldierBlue-attack01_%s.png",startIndex = 0,endIndex = 39,time= 0.03 },
		-- 		["attack02"] = {str = "LowerSoldierBlue-attack02_%s.png",startIndex = 0,endIndex = 39,time= 0.03 },
		-- 	}
		-- },
