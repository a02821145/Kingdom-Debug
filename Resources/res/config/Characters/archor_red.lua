local conf = 
{
	...
	displayProperty = 
	{
		...
		[5] = {com = "MoveComponent",icon="d2331pixekicon64_234.png", displayName =  "@PropertySpeed",upAdd = "spd",vName = "maxSpeed"},
	},
	...
	components = 
	{
...

		{
			...
			csbPath = "UI/characters/AnchorRed.csb",
		...
		-- 	pngPath = "UI/TextureUI/AnchorRed.png",
		-- 	defaultSp = "AnchorRed-stand01_00.png",
		...
		-- 	aniAttackCallback = 
		-- 	{
		-- 		"AnchorRed-attack_09.png",
		-- 		"AnchorRed-shoot_15.png",
		-- 	},

		-- 	aniStrMap = 
		-- 	{
		-- 		["stand01"] = {str = "AnchorRed-stand01_%s.png",startIndex = 0,endIndex = 29,time= 0.03 },
		-- 		["stand02"] = {str = "AnchorRed-stand02_%s.png",startIndex = 0,endIndex = 59,time= 0.03 },
		-- 		["die"] = {str = "AnchorRed-die_%s.png",startIndex = 0,endIndex = 47,time= 0.03 },
		-- 		["attack"] = {str = "AnchorRed-attack_%s.png",startIndex = 0,endIndex = 25,time= 0.03 },
		-- 		["walk"] = {str = "AnchorRed-walk_%s.png",startIndex = 0,endIndex = 23,time= 0.03 },
		-- 		["shoot"] = {str = "AnchorRed-shoot_%s.png",startIndex = 0,endIndex = 37,time= 0.03 },
		-- 	}
		-- },
